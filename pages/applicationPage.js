                ...
                <hr className="mt-6 border-b-1 border-blueGray-300" />
                    <div>
                        <p className="mb-4 text-LG text-gray-600">
                            Do you have a need of skilled and professional
                            Service Men?
                            
                            <b> SKILL OVER</b> will fill it with best at with the 
                            best at all minimal cost
                        </p>
                    </div>
                ...
                <form>
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    >
                      ...
                      <option value="saab">1 Day</option>
                      <option value="saab">1 Month</option>
                      <option value="saab">Indefinite</option>
                    </select>
                  </div>
